...
namespace Project::Graph::Node
{
  class SaveGetBool : public Base
  {
    ...
    public:
      constexpr static const char* NAME = ICON_MDI_DATABASE_ARROW_LEFT " Save Get Bool";
      ...
      SaveGetBool()
      {
        ...
        addOUT<TypeValue>("Value", pinStyle(PinDataType::Bool));
      }
      ...
      void build(BuildCtx &ctx) override {
        ...
        ctx.globalVar("bool", resVar, false);
