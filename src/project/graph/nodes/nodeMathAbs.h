...
{
  class MathAbs : public Base
  {
    public:
      constexpr static const char* NAME = ICON_MDI_FUNCTION " Abs";
      ...
      MathAbs()
      {
        ...
        addOUT<TypeValue>("|X|", pinStyle(PinDataType::Float));
      }
    ...
    private:
      void emit(BuildCtx &ctx, bool asPure) {
        ...
        MathHelpers::emitFloat(ctx, uuid, "fabsf((float)(" + x + "))", asPure);
      }
  };
}
