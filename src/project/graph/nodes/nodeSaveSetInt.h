...
namespace Project::Graph::Node
{
  class SaveSetInt : public Base
  {
    ...
    public:
      constexpr static const char* NAME = ICON_MDI_DATABASE_ARROW_RIGHT " Save Set Int";
      ...
      SaveSetInt()
      {
        ...
        addIN<TypeValue>("Value", ImFlow::ConnectionFilter::SameType(), pinStyle(PinDataType::Int));
        valInputTypes = {0, 1};
      ...
      void build(BuildCtx &ctx) override {
        ...
        ctx.line("Game::Save::" + call + "((int32_t)(" + val + "));");
      }
  };
}
