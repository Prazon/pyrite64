...
{
  class MathCeil : public Base
  {
    public:
      constexpr static const char* NAME = ICON_MDI_ARROW_COLLAPSE_UP " Ceil";
      ...
      MathCeil()
      {
        ...
        addOUT<TypeValue>("Ceil", pinStyle(PinDataType::Float));
      }
    ...
    private:
      void emit(BuildCtx &ctx, bool asPure) {
        ...
        MathHelpers::emitFloat(ctx, uuid, "ceilf((float)(" + x + "))", asPure);
      }
  };
}
