...
namespace Project::Graph::Node
{
  class SaveSetBool : public Base
  {
    ...
    public:
      constexpr static const char* NAME = ICON_MDI_DATABASE_ARROW_RIGHT " Save Set Bool";
      ...
      SaveSetBool()
      {
        ...
        addIN<TypeValue>("Value", ImFlow::ConnectionFilter::SameType(), pinStyle(PinDataType::Bool));
        valInputTypes = {0, 1};
      ...
      void draw() override {
        SaveHelpers::drawSelectors(groupUUID, fieldName,
          (int)::Project::Assets::SaveFileAsset::FT_BOOL);
      }
      ...
      void build(BuildCtx &ctx) override {
        ...
        ctx.line("Game::Save::" + call + "((bool)(" + val + "));");
      }
  };
}
