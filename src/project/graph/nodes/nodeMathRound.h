...
{
  class MathRound : public Base
  {
    public:
      constexpr static const char* NAME = ICON_MDI_CIRCLE_OUTLINE " Round";
      ...
      MathRound()
      {
        ...
        addOUT<TypeValue>("Round", pinStyle(PinDataType::Float));
      }
    ...
    private:
      void emit(BuildCtx &ctx, bool asPure) {
        ...
        MathHelpers::emitFloat(ctx, uuid, "roundf((float)(" + x + "))", asPure);
      }
  };
}
